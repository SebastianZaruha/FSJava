...
public class IncidenceController {
    ...
    @DeleteMapping("")
    public ResponseEntity<Void> deleteIncidence(@RequestParam(name = "incidenceId") Long id) {
        try {
    ...
    public ResponseEntity<Void> partialUpdateIncidence(@PathVariable(name = "id") Long id,
            @RequestBody IncidenceDTO incidenceDto) {
        try {
